...
import net.mcreator.buildcraftreloaded.block.GbnfhvfgdhbBlock;
...
public class BuildCraftReloadedModBlocks {
	...
	public static final RegistryObject<Block> GBNFHVFGDHB = REGISTRY.register("gbnfhvfgdhb", () -> new GbnfhvfgdhbBlock());
}
